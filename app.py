...
app.title = "Dashboard HealthSystem"
server = app.server
    ...
    return html.Div(
        ...
        children=[
            html.Div(
                id="banner-text",
                children=[
                    html.H5("Dashboard HealthSystem"),
                    html.H6("Monitoramento de indicadores que geram poder decisorio."),
                ],
            ),
            html.Div(
                id="banner-logo",
                children=[
                    html.A(
                        html.Button(children="Suporte"),
                        href="https://plotly.com/get-demo/",
                    ),
                    html.Button(
                        id="learn-more-button", children="Saiba Mais", n_clicks=0
                    ),
                    html.A(
                ...
                children=[
                    ...
                    html.Div(
                        ...
                        children=dcc.Markdown(
                            children=(
                                """
                        ###### O que essa Dashboard faz?

                        Este é um painel para monitorar a qualidade do hardware distribuido em tempo real ao longo da linha de produção da empresa.
    ...
    return generate_metric_row(
        ...
        None,
        {
            ...
            "children": html.Button(
                ...
                children=item,
                title="Clique para visualizar o grafico",
                n_clicks=0,
            ),
        },
...
def stop_production(n_clicks, current):
    if n_clicks == 0:
        return True, "começar"
    return not current, "interromper" if current else "começar"
